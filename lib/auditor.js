;/*
	...
	auditor - an audit log module for node.js
	==============================================================

	auditor.log(actor,context,action,target,description,data)
...
var Auditor = (function () {
	...
	var AuditorInstance = function (options) {
	...
	_.extend(AuditorInstance.prototype, {
...
Auditor.transports.ConsoleTransport = (function () {
...
Auditor.transports.MongoTransport = (function () {
...
exports = module.exports = Auditor;